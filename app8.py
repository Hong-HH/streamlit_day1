...
def main() :
    ...
    if choice == 'Image' :
        ...
        if image_file is not None :
            ...
            #image_file.name = now + image_type
            #print(now + image_type)
